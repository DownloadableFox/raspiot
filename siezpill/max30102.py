# The following file is a slight modification over an old library
# Original: https://github.com/doug-burrell/max30102/blob/master/max30102.py
#
# There doesn't seem to be any new or even somewhat complete libraries for the hw-605
